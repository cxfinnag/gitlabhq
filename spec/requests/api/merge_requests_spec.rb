...
describe API::API do
  ...
  let!(:merge_request) { create(:merge_request, author: user, assignee: user, source_project: project, target_project: project, title: "Test", description: "Test description") }
  before {
  ...
  describe "GET /projects/:id/merge_requests" do
    ...
    context "when authenticated" do
      it "should return an array of merge_requests" do
        ...
        json_response.first['description'].should == merge_request.description
      end
    end
  end
    ...
    context 'between branches projects' do
      it "should return merge_request" do
        post api("/projects/#{project.id}/merge_requests", user),
             title: 'Test merge_request', source_branch: "stable", target_branch: "master", author: user, description: "Test desc"
        response.status.should == 201
        json_response['title'].should == 'Test merge_request'
        json_response['description'].should == 'Test desc'
      end
